...
//		c.SetFrameFillStyle(3019);
		...
		/* black lab mode */
		mg1.GetXaxis()->SetTitleColor(0);
		mg1.GetXaxis()->SetLabelColor(0);
		mg1.GetXaxis()->SetAxisColor(0);
		mg1.GetYaxis()->SetTitleColor(0);
		mg1.GetYaxis()->SetLabelColor(0);
		mg1.GetYaxis()->SetAxisColor(0);
		tl->SetFillStyle(0);
		tl->SetTextColor(0);
